  ...
  <section class="page-section">
    <div class="container text-center">
	    ...
	    <div class="col-lg-12 text-center aaa" data-aos="zoom-in">
	        ...
	        <h3 class="section-subheading text-muted">MyInfoUpdate</h3>
	    </div>
	    ...
	    <div class="container">
    		<div class="row">
			    <table>			    
			  		<tr>
			    		...
			    		<td><input type="text" value="${upmyinfodto.user_name }" readonly="readonly" class="inputbox"></td>
			    	</tr>
			    	
			    	<tr>
			    		<th><h5 class="section-subheading text-muted">생일</h5></th>
			    		<td><input type="text" value="${upmyinfodto.user_birth }" readonly="readonly" class="inputbox"></td>
			    	</tr>
			    	
			    	<tr>
			    		<th><h5 class="section-subheading text-muted">성별</h5></th>
			    		<td><input type="text" value="${upmyinfodto.user_gender }" readonly="readonly" class="inputbox"></td>
			    	</tr>
			    	<tr>
			    		<th><h5 class="section-subheading text-muted">현재 비밀번호</h5></th>
			    		<td><input type="text" value="${upmyinfodto.user_pw }" class="inputbox" readonly="readonly"></td>
			    	</tr>
			    	...
			    	<tr>
			    		...
			    		<td><input type="text" name="user_phone" value="${upmyinfodto.user_phone }" class="inputbox"></td>
			    	</tr>
			    	
			    	<tr>
			    		<th><h5 class="section-subheading text-muted">이메일</h5></th>
			    		<td><input type="text" name="user_email" value="${upmyinfodto.user_email }" class="inputbox"></td>
			    	</tr>
			    </table>
			</div>
	  	</div>
	  	...
	  	<div class="container">
	  	<div class="btdiv">
	  		<input type="button" value="취소" onclick="location.href='UserServlet.do?command=myinfo&user_no=${upmyinfodto.user_no}'">
